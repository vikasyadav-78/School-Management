...
import { FaFilter, FaSearch, FaArrowLeft, FaHospital } from "react-icons/fa";
import { getStaffAttendanceHistory } from "@/features/admin/services/admin.service";
...
export default function StaffAttendanceReportsPage() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      const data = await getStaffAttendanceHistory(params);
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-4 flex flex-wrap items-center gap-4">
          ...
          <div className="relative flex-1 min-w-50 max-w-xs">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 border border-zinc-200 rounded-xl text-xs outline-none bg-zinc-50 focus:bg-white focus:border-sky-500 font-semibold"
            />
          </div>
