      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-zinc-200/80 shadow-sm text-center flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-base font-extrabold text-zinc-800">{studentName}</h3>
            <p className="text-xs text-zinc-400 mt-1">
              ID: {student.student_id || "N/A"} • Class {student.class || student.class_name || "N/A"}-{student.section || student.section_name || "N/A"}
            </p>
            ...
            {school.name && (
              <div className="inline-flex items-center justify-center gap-2 bg-zinc-50 border border-zinc-100 p-2 rounded-xl mt-3 text-xs w-full">
                ...
                <span className="text-[10px] font-extrabold text-zinc-600 uppercase tracking-wide truncate">
                  {school.name}
                </span>
              </div>
            )}
          ...
          <div className="border-t border-zinc-100 my-6 pt-6 text-left space-y-4 text-xs text-zinc-600">
            <div className="flex items-center gap-3">
              <FaAddressCard className="text-zinc-400 w-4 h-4 shrink-0" />
              <div>
                <span className="text-[10px] text-zinc-400 font-bold block uppercase tracking-wider">Admission No</span>
                <span className="font-semibold text-zinc-800">{student.admission_no || "N/A"}</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="font-semibold text-zinc-800">{student.admission_date || "N/A"}</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="font-semibold text-zinc-800">{student.apaar_id || "N/A"}</span>
              </div>
            </div>
            
            <div className="pt-4 border-t border-zinc-100">
              <Link href="/student/change-password" opacity="1" className="w-full block">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-zinc-200/80 shadow-sm space-y-8">
          ...
          {/* Personal Registry */}
          <div>
            <h3 className="text-xs font-bold text-zinc-700 uppercase tracking-wider border-b border-zinc-100 pb-2 mb-4">Personal Details</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs">
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">First Name</span>
                <span className="text-zinc-800 font-extrabold text-sm">{student.first_name || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Last Name</span>
                <span className="text-zinc-800 font-extrabold text-sm">{student.last_name || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Roll Number</span>
                <span className="text-zinc-800 font-bold text-sm">{student.roll_no || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Gender</span>
                <span className="text-zinc-700 font-semibold capitalize">{student.gender || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Date of Birth</span>
                <span className="text-zinc-700 font-semibold">{student.date_of_birth || "N/A"}</span>
              </div>
          ...
          <div>
            <h3 className="text-xs font-bold text-zinc-700 uppercase tracking-wider border-b border-zinc-100 pb-2 mb-4">Guardian Information</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs">
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Father's Name</span>
                <span className="text-zinc-700 font-semibold">{student.father_name || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Mother's Name</span>
                <span className="text-zinc-700 font-semibold">{student.mother_name || "N/A"}</span>
              </div>
              <div className="space-y-1">
                <span className="font-bold text-zinc-400 block uppercase tracking-wider text-[9px]">Guardian Phone Number</span>
                <div className="flex items-center gap-2 text-zinc-700 font-semibold mt-1">
                  <FaPhone className="text-zinc-400 rotate-90" />
                  <span>{student.guardian_phone || student.phone || "N/A"}</span>
                </div>
              </div>
            </div>
          </div>
