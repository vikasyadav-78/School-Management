...
import { getTeacherOnlineMcqPassFailReports, getTeacherOnlineMcqMeta } from "@/features/teachers/services/teacher.service";
import { toast } from "sonner";

export default function TeacherOnlineMcqPassFailReportPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const res = await getTeacherOnlineMcqPassFailReports({
        class_id: selectedClassId || undefined
      });
      setReports(res.rows || res.data || []);

      // Load exams/classes metadata
      const meta = await getTeacherOnlineMcqMeta();
