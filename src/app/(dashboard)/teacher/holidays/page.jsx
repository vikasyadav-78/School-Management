      ...
      {viewMode === "card" ? (
        filteredHolidays.length === 0 ? (
          <div className="p-12 bg-white rounded-2xl border border-zinc-200 shadow-sm text-center">
            <span className="text-zinc-400 font-bold uppercase tracking-wider text-xs block mb-2">No Holidays Found</span>
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden p-6 text-xs">
          ...
          <div className="grid grid-cols-7 gap-2">
            {calendarCells.map((date, idx) => {
              ...
              if (holiday) {
                if (holiday.is_ongoing || holiday.status?.toLowerCase() === "ongoing") cellStyle = "bg-emerald-50 text-emerald-800 border border-emerald-300 font-bold hover:bg-emerald-100 cursor-pointer";
                else if (holiday.is_upcoming || holiday.status?.toLowerCase() === "upcoming") cellStyle = "bg-blue-50 text-blue-800 border border-blue-300 font-bold hover:bg-blue-100 cursor-pointer";
                  ...
                  return (
                    <div className="space-y-4 text-left">
                      ...
                      <div className="text-[9px] text-zinc-500 font-bold uppercase tracking-wider pt-4 border-t border-zinc-100 flex justify-between">
                        ...
                        <span>{activeDetail.announced_at_label || activeDetail.announced_at || "N/A"}</span>
                      </div>
                    </div>
                  );
                })()
